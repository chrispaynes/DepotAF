...
GRANT ALL PRIVILEGES ON DATABASE airflowdb to admin;
ALTER ROLE admin SET search_path = alpha;

-- ALTER READ_WRITE USER ROLE
GRANT ALL PRIVILEGES ON DATABASE airflowdb to postgres;
GRANT CONNECT ON DATABASE airflowdb TO postgres;
